...
delay();
$('#chat-messages').append('<div class="chat-update"><span class="chat-text">Welcome to the Insanity Realms music room!  -DerekZil  Come join us on Minecraft: InsanityRealms.zapto.org</span></div>');
