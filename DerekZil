...
function displayUI() {
	...
	$('#side-right .sidebar-content').append(
		...
		+	'<a id="plug-btn-rules" title="Sends rules." style="color:#FF8C00">Post Rules</a>'
		+	'<a id="plug-btn-face" title="Sends Facebook link." style="color:#FF8C00">Facebook Link</a>'
		+	'<a id="plug-btn-fans" title="Sends fan message." style="color:#FF8C00">No Fan</a>'
...
delay();
$('#chat-messages').append('<div class="chat-update"><span class="chat-text">Welcome to the Insanity Realms music room!  -DerekZil Come join us on Minecraft!  IP: InsanityRealms.zapto.org</span></div>');
